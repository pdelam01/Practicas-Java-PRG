...
public class Apartado030101 extends Apartado {
	...
	public void ejercicio01() {
		...
		Alumno alumnonadie = new Alumno();
		alumno.asignarNota(nota);
		System.out.println(alumno);
		System.out.println(alumnonadie);
		//Inicio modificacion
	...
	public void ejercicio08() {
		...
		if(a>b){
			...
			b=a-b;
			a=a-b;
			System.out.println("Intercambiados los números, el primero es " +a+ " y el segundo es: "+b);
		}else{
			System.out.println("El primero número es: " +a+ " y el segundo es: "+b);
		}
	...
	public void ejercicio09() {
        ...
        if (n1 == n2){
        	//COMPARA (==) DIRECCIONES DE MEMORIA, valido para datos primitivos pero no objetos
