...
public class Apartado030202 extends Apartado {
	...
	public void ejercicio05() {
		...
		//Creamos una persona1 de tipo titular
		Titular persona1= new Titular ("714656644D","Feliciano",25,100);
		CuentaBancaria cuenta1 = new CuentaBancaria(1000,persona1);
		cuenta1.anyadir(new Titular("115458222D","Pedro",35,150));
		cuenta1.anyadir(new Titular("577225588G","Ana",34,384));
		miBanco.anyadir(cuenta1);

		Titular persona2= new Titular ("714735666Y","Pulpino",65,101);
		CuentaBancaria cuenta2 = new CuentaBancaria(0,persona2);
		cuenta2.anyadir(new Titular("74992586Y","Carlos",18,2019));
